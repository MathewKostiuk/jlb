...
function SwatchesConstructor(t, e) {
    var n = this;
    n.show_unavailable_options = e.show_unavailable_options || !1, n.productIsValid = n.show_unavailable_options || t.available, 
    n.product_json = t, n.options_name = "", n.options = "", n.viewDesign = window.viewButtons, 
    n.designOption1 = e.designOption1 || "getButtonHtml", n.designOption2 = e.designOption2 || "getButtonHtml", 
    n.designOption3 = e.designOption3 || "getButtonHtml", n.contentParent = e.contentParent, 
    n.enableHistoryState = Boolean(e.enableHistoryState) || !1, n.callback = e.callback || !1, 
    n.texture_obj = e.externalImagesObject || {}, n.colors_obj = e.externalColors || {}, 
    n.color_with_border = e.colorWithBorder || {}, n.product_handle = e.productHandle || {}, 
    n.selectedByDefault = void 0 === e.selectedByDefault || e.selectedByDefault, n.productIsValid && "Title" != t.options && $(n.contentParent).length ? n.initSwatches() : n.callExternalVariantHandler(n.callback, t.variants[0], n.getJsonObject());
}
...
function getAllOptions(t, e) {
    for (var n = !0, a = {}, i = 0; i < t.length; i++) {
        ...
        null != o && n && (null != l ? (a[o] = a[o] || {}, null != r ? (a[o][l] = a[o][l] || {}, 
...
function getCurrentVariantByTitle(t, e, n) {
    ...
    for (var a = !0, i = 0; i < t.length; i++) {
        ...
        i == t.length - 1 && e.indexOf("/") > -1 && ((e = e.split("/")).pop(), e = e.length > 1 ? e.join("/") : e, 
        i = 0, a = !1);
    }
    return t[0];
}
...
function getVariantIdUrl() {
    ...
    return t.indexOf("variant=") > -1 && (t = t.match(/variant=\d+/g), t = parseInt(t[0].match(/\d+/g))), 
    t;
}
...
function viewButtons(t, e) {
    ...
    switch (t) {
      ...
      case "getGroupHtml":
        return '<div class="' + n.replace(/([\.#])/g, "") + '">' + ('<div class="tt-title-options" data-group-title="' + e.title + '">' + e.title + ': <span class="current_option_name"></span></div>') + '<ul class="tt-options-swatch options-large">' + e.html + "</ul></div>";

      case "getButtonHtml":
        var o = e.value.trim(), l = o.toLowerCase(), r = e.c_border.indexOf(o) > -1 ? " border" : "", c = e.producthandle;
        ...
        var u = s.indexOf("data-optionimage") > -1 ? ' class="options-color-image"' : "", d = i ? "" : "<span" + u + "></span>", p = o.indexOf('"') > -1 ? "'" + o + "'" : '"' + o + '"';
...
SwatchesConstructor.prototype.destroy = function() {
    ...
    var a = getCurrentVariantById(e.getJsonObject().variants, t, e.show_unavailable_options), i = getCurrentOptionsArray(a);
    e.createOptionsView(e.contentParent, e.options, e.options_name, i), e[n("getFunctionClickHandler")](), 
    e.callExternalVariantHandler(e.callback, a, e.getJsonObject()), e.selectedByDefault = !0;
    ...
    e.createSwatches(n.id), $(e.contentParent).closest(".tt-product-single-info").find(".input_variant").val(n.id);
}, SwatchesConstructor.prototype.createOptionsView = function(t, e, n, a) {
    var i = this, o = i.viewDesign, l = $(t).empty(), r = i.texture_obj, c = i.colors_obj, s = i.color_with_border, u = "", d = "", p = "", f = [ i.designOption1, i.designOption2, i.designOption3 ], v = i.product_handle, h = i.selectedByDefault, g = !1;
    $.each(e, function(t, i) {
...
function swatchVariantButtonHandler(_parent, variant) {
  ...
  if (_btnaddtocart) {
    _btnaddtocart[0].disabled = !Boolean(variant.available);
    _btnaddtocart[0].textContent = Boolean(variant.available) ? 'ADD TO CART' : 'SOLD OUT';
  }

  if(_btnaddtocart.length == 0 || !backInStockForm) return false
  // Form
